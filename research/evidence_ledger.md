...
| I11 | `analysis/results/phase3_benchmark.json`, `artifacts/phase3/profiler/` | FP64/PyTorch/HIP correctness gates pass on MI300X and native kernels are profiled, but optimized CauchyLift is 5.8953× fused AdamW on the representative BF16 suite | Phase 3 engineering negative; gate is `REVISE` |
